...
const Contact = () => {
  ...
  return (
    <>
      ...
      >
        <div className="w-full px-5 md:w-[90%] lg:w-[90%] xl:w-4/5 md:mx-auto md:px-0 flex flex-col lg:flex-row items-center gap-10">
          {/* Left Side - Form */}
          ...
          >
            <div className="bg-[#111116]/40 flex flex-col gap-5 p-5 lg:p-10 rounded-2xl">
              ...
              <p className="text-md text-gray-300">
                ...
                you shortly. I would be delighted to hear from you and welcome
