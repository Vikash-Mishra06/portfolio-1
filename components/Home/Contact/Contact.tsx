...
const Contact = () => {
  ...
  return (
    <motion.div
      ...
      id='contact'
      className='flex flex-col lg:flex-row items-center bg-[#000000] gap-10 px-4 sm:px-12 lg:px-24 xl:px-40 pt-20 pb-10 text-gray-700 dark:text-white'
    >
      ...
      >
        ...
        <div className=' flex flex-col'>
          ...
          <div className='flex pl-3 rounded-lg border border-gray-400 dark:border-gray-600 items-center'>
            <img src='/images/person_icon.svg' alt="Person Icon" className="mr-2" />
            <input
              id="name"
              name="name"
              type="text"
        ...
        <div className=' flex flex-col'>
          ...
          <div className='flex pl-3 rounded-lg border border-gray-400 dark:border-gray-600 items-center'>
            <img src='/images/email_icon.svg' alt="Email Icon" className="mr-2" />
            <input
              id="email"
              name="email"
              type="email"
        ...
        <div className='sm:col-span-2 flex flex-col'>
          <label htmlFor="message" className='mb-2 text-sm font-medium'>Enter Message</label>
      ...
      {/* Result Message */}
      {/* {result && <span className='mt-3 text-sm text-gray-500 dark:text-gray-300'>{result}</span>} */}
    </motion.div>
  );
};
